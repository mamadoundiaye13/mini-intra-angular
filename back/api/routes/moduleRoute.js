module.exports = (app) => {
    ...
    .post(authadmin.loginRequired, moduleController.create_a_module); // demander à l'amin de s'identifier avant de créer un module
  
    app.route('/modules/:module_id')
    .get(authadmin.loginRequired, moduleController.get_a_module)
